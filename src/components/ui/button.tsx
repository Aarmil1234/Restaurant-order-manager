  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        order: "bg-gradient-primary text-white font-semibold hover:shadow-elevated transition-bounce transform hover:scale-105",
        quantity: "bg-restaurant-cream border border-restaurant-orange/20 text-restaurant-charcoal hover:bg-restaurant-orange hover:text-white transition-smooth",
        admin: "bg-restaurant-golden text-white font-medium hover:bg-restaurant-golden/90 transition-smooth",
        prepared: "bg-restaurant-red text-white font-medium hover:bg-restaurant-red/90 transition-smooth",
      },
      size: {
